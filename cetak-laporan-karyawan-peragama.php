...
$karyawan = select("select * from tb_karyawan where id_agama = '{$_GET['id_agama']}'");
$deskripsi = select("select * from tb_agama where id_agama = '{$_GET['id_agama']}'")[0]['nama_agama'];
...
<body>
  ...
  <div class="header">
    <h3>Data Karyawan Agama <?=$deskripsi?></h3>
  </div>
