...
$karyawan = select("select * from tb_karyawan left join tb_bagian on tb_bagian.id_bagian = tb_karyawan.id_bagian where tb_bagian.is_medis = '{$_GET['is_medis']}'");
...
<body>
  ...
  <div id="printDiv">
    <div class="header">
      <h3>Data Karyawan Bagian <?php echo ($_GET['is_medis'] == 1 ? 'Medis' : 'Non Medis') ?></h3>
    </div>
