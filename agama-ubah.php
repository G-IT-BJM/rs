      ...
      <div class="card-body">
        ...
        <form action="agama-action.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="id_agama" id="id_agama" class="form-control" readonly="true" value="<?=$id_agama?>" required>
          </div>
          <div class="form-group">
            <div class="control-label">
              Agama
            </div>
            <input autofocus type="text" name="nama_agama" id="nama_agama" class="form-control" value="<?=$nama_agama?>" required>
          </div>
          <div class="form-group">
