...
$karyawan = select("select * from tb_karyawan where id_bagian = '{$_GET['id_bagian']}'");
$deskripsi = select("select * from tb_bagian where id_bagian = '{$_GET['id_bagian']}'")[0]['nama_bagian'];
...
<body>
  ...
  <div id="printDiv">
    <div class="header">
      <h3>Data Karyawan Bagian <?= $deskripsi ?></h3>
    </div>
